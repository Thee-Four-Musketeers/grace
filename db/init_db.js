...
async function buildTables() {
    try {
        ...
        await client.query(`
            ...
            CREATE TYPE choice AS ENUM ('cheese', 'meat', 'fruit', 'board', 'nut');
            CREATE TYPE urgency AS ENUM ('overnight', 'twoday', 'ground', 'usps');
        ...
        //should customer refer to username or customer id??
